...
# (which is true with the birds dataset), you should exclude the last layer
...
if [[ "${train_whole_model}" == "true" ]]; then
  ...
  python train_image_classifier_birds.py \
    --train_dir="${TRAIN_DIR}" \
    --dataset_name=birds \
